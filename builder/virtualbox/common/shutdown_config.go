...
type ShutdownConfig struct {
	...
	ShutdownCommand      string `mapstructure:"shutdown_command" required:"false" required:"false"`
	...
	RawShutdownTimeout   string `mapstructure:"shutdown_timeout" required:"false" required:"false"`
	// The amount of time to wait after shutting down the virtual machine. If you get the error Error removing floppy controller, you might need to set this to 5m or so. By default, the delay is 0s or disabled.
	RawPostShutdownDelay string `mapstructure:"post_shutdown_delay" required:"false" required:"false"`
