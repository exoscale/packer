...
type TencentCloudAccessConfig struct {
	// Tencentcloud secret id. You should set it directly, or set the TENCENTCLOUD_ACCESS_KEY environment variable.
	SecretId       string `mapstructure:"secret_id" required:"true"`
	// Tencentcloud secret key. You should set it directly, or set the TENCENTCLOUD_SECRET_KEY environment variable.
	SecretKey      string `mapstructure:"secret_key" required:"true"`
	// The region where your cvm will be launch. You should reference Region and Zone  for parameter taking.
