...
type TencentCloudRunConfig struct {
	// Whether allocate public ip to your cvm. Default value is false.
	...
	// Root disk type your cvm will be launched by. you could reference Disk Type for parameter taking.
	...
	// Specify vpc name you will create. if vpc_id is not set, packer will create a vpc for you named this parameter.
	...
	// Specify subnet name you will create. if subnet_id is not set, packer will create a subnet for you named this parameter.
	...
	// Specify cider block of the subnet you will create if subnet_id not set
	SubnectCidrBlock         string `mapstructure:"subnect_cidr_block" required:"false"`
	InternetChargeType       string `mapstructure:"internet_charge_type"`
	// Max bandwidth out your cvm will be launched by(in MB). values can be set between 1 ~ 100.
